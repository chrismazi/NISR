              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="email" placeholder="name@nisr.gov.rw" type="email" required className="pl-10" />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="organization" placeholder="Ministry, Department, or Agency" required />
                </div>
